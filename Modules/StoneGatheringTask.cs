...
{
    public class StoneGatheringTask : IBotTask
    {
        ...
        public StoneGatheringTask(AdbController adb)
        {
            _adb = adb;
            _nav = new NavigationHelper(adb);
        }

        public string Name => "Stone Auto-Gather";
        ...
        public void Run()
        {
            ...
            while (true)
            {
                ...
                {
                    // Maybe menu is already open? Try clicking Stone directly.
                }
                ...
                if (!ClickAndWait("assets/icon_Stone.png", "Stone Icon"))
                {
                    Logger.Log("Gather", "Stone icon not found.");
                    _adb.SendBackKey();
                    break;
                }
